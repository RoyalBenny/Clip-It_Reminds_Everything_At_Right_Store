...
var isRestored = 0
class DeleteRecyclerViewAdapterClass(val list: MutableCollection<MutableList<ItemClass>>, val context: Context, val db: JsonDataBase) : RecyclerView.Adapter<DeleteRecyclerViewAdapterClass.ViewHolder>() {

    private val newtypefaceCategory = Typeface.createFromAsset(context.assets, "fonts/Karma-Regular.ttf")!!
    private val newtypefaceItems = Typeface.createFromAsset(context.assets, "fonts/Oxygen-Light.ttf")!!
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.categoryTextView.typeface = newtypefaceCategory
        holder.itemTextView.typeface = newtypefaceItems
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            card.setOnLongClickListener {
                ...
                popupMenu.inflate(R.menu.delete_window_pop_up_menu)
                ...
                popupMenu.setOnMenuItemClickListener { pi ->
                    when (pi.itemId) {
                        R.id.delete_in_delete_window -> {

                            list.elementAt(layoutPosition).forEach { ki ->

                                db.deletePermanently(ki)
