...
class CountryPhoneId {

    val countryNames = arrayOf("Afghanistan", "Albania", "Algeria", "Andorra",
            ...
            "Djibouti", "Timor-leste", "Ecuador", "Egypt", "El Salvador", "Equatorial" +
